...
To begin with we will configure the MQ queue manager on the IBM Cloud Pak for Integration for our MQ messages. We will then configure the source connector to run some tests to a local
